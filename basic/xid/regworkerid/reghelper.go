...
// Validate 校验 WorkerId
func Validate(workerId int32) bool {
	return xarray.Contain(_workerIdList, workerId)
}
...
// maxWorkerId: WorkerId 最大值，示例：63 取决于 WorkerIdBitLength 默认6  最大值为 2^WorkerIdBitLength-1
